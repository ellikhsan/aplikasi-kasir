...
namespace Aplikasi_kasir
{
    public partial class FormMasterBarang : Form
    {
        ...
        {
            if (textBox1.Text.Trim() == "" || textBox2.Text.Trim() == "" || textBox3.Text.Trim() == "" || textBox3.Text.Trim() == "" || textBox4.Text.Trim() == "" || textBox5.Text.Trim() == "" || comboBox1.Text.Trim() == "")
            {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                conn.Open();
                cmd.ExecuteNonQuery();
                MessageBox.Show("data udah ke apus");
                KondisiAwal();
            }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlConnection conn = konn.GetConn();
                cmd = new SqlCommand("Update TBL_BARANG set NamaBarang='" + textBox2.Text + "',HargaBeli='" + textBox3.Text + "',HargaJual='" + textBox4.Text + "',JumlahBarang='" + comboBox1.Text + "' where KodeBarang'" + textBox1.Text + "'", conn);
                conn.Open();
                cmd.ExecuteNonQuery();
